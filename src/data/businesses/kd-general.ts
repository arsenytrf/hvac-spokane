...
export const config: BusinessConfig = {
  ...
  galleryImages: [
    { src: u("photo-1600596542815-ffad4c1539a9"), alt: "Modern kitchen remodel with quartz countertops", tag: "Kitchen" },
    { src: u("photo-1600573472592-401b489a3cdc"), alt: "Custom tile bathroom renovation", tag: "Bathroom" },
    { src: u("photo-1504307651254-35680f356dfd"), alt: "Active construction site", tag: "Construction" },
    { src: u("photo-1560518883-ce09059eeffa"), alt: "Home renovation in progress", tag: "Remodel" },
    { src: u("photo-1600585154340-be6161a56a0c"), alt: "Hardwood flooring installation", tag: "Flooring" },
    { src: u("photo-1632923057155-1c05a7cf3bb4"), alt: "Basement framing and insulation", tag: "Basement" },
    { src: u("photo-1541123603104-512919d6a96c"), alt: "Room addition framing", tag: "Addition" },
    { src: u("photo-1581094794329-c8112a89af12"), alt: "Demolition and site prep work", tag: "Demolition" },
    { src: u("photo-1600566753376-12c8ab7fb75b"), alt: "Finished living space with new flooring", tag: "Interior" },
    { src: u("photo-1574359411659-15573a27fd0c"), alt: "Exterior construction progress", tag: "Construction" },
    { src: u("photo-1503387762-592deb58ef4e"), alt: "Aerial view of residential project", tag: "Overview" },
    { src: u("photo-1613545325278-f24b0cae1224"), alt: "Completed whole home remodel interior", tag: "Remodel" },
  ],
